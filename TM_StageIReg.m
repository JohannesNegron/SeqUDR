...
for i = 1:nargin
    ...
    Stage1OutputDirMaster = [folder, '_calib'];
    ...
    for i=1:n_files
        ...
        if strfind(long_name, "RED") > 0
            ...
            Handbag.Slave.Traslation = [58.0, -18.0];
            SlaveImg = StageIReg(Img,Handbag);
        end
        if strfind(long_name, "REG") > 0
            ...
            Handbag.Slave.Traslation = [15.0 ,0.0];
            SlaveImg = StageIReg(Img,Handbag);
        end
        if strfind(long_name, "NIR") > 0
            ...
            Handbag.Slave.Traslation = [15.0 ,-15.0];
            SlaveImg = StageIReg(Img,Handbag);
        end
